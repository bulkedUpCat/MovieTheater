        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteMovieGenre = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteListUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteList", x => new { x.FavoriteListMoviesId, x.FavoriteListUsersId });
                    table.ForeignKey(
                        name: "FK_FavoriteList_AspNetUsers_FavoriteListUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchLaterUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchLater", x => new { x.WatchLaterMoviesId, x.WatchLaterUsersId });
                    table.ForeignKey(
                        name: "FK_WatchLater_AspNetUsers_WatchLaterUsersId",
